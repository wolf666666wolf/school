...
public class ConfigInfo
{
    ...
    public static String GetValuebyArea(String inpfieldname)
    {
        ...
        try
        {
            ...
            log.addlog("AppConfig.properties的绝对路径"+tFile.getAbsolutePath());
            FileInputStream readconfig = new FileInputStream(ConfigFilePath); //文件对象
    ...
    public static Vector GetIniByIp(String inpip)
    {
        ...
        {
            log.addlog((String) Strvector.get(i));
        }
...
//        log.addlog(test.GetValuebyName(SysConst.USERLOGPATH));
//        log.addlog(System.getProperty("user.home"));
    }
}
