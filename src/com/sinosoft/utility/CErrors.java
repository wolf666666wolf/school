...
//        log.addlog(te1.getErrorCount());
//        log.addlog(te1.getFirstError());
//        log.addlog(te1.needDealError());
//        if (te1.needDealError())
//        {
//            log.addlog("Need Error");
//        }
//        else
//        {
//            log.addlog("Not Need Error");
//        }
      ...
      log.addlog(es.mErrors.getErrContent());
    }
}
