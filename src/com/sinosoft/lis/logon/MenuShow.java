...
//        }
//        //调用生成菜单函数
//        log.addlog("menuCount before getMenu");
//        log.addlog(menuCount[0]);
//        MenuShow tmenuShow = new MenuShow();
//        log.addlog("nodecount:" + node_count);
//        log.addlog("menuCount" + menuCount);
//        String menushowstr = tmenuShow.getMenu(node, 0, node_count, menuCount);
//        log.addlog("menuCount after getMenu");
//        log.addlog(menuCount[0]);
//        int totalMenu = menuCount[0] + 3;
//        log.addlog("complete getMenu");
    }
}
