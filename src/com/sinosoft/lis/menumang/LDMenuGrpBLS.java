...
//        System.out.println("End LDMenuGrp BLS Submit...");
    ...
    private boolean deldata(VData mInputData)
    {
    	LDMenuGrpSchema tLDMenuGrpSchema = new LDMenuGrpSchema();
    	tLDMenuGrpSchema = (LDMenuGrpSchema) mInputData.getObjectByObjectName("LDMenuGrpSchema", 0);
    	String delSQL1 = "delete from ldmenugrp where menugrpcode = '"+tLDMenuGrpSchema.getMenuGrpCode()+"'";
    	String delSQL2 = "delete from ldmenugrptomenu where menugrpcode = '"+tLDMenuGrpSchema.getMenuGrpCode()+"'";
    	MMap map = new  MMap();
