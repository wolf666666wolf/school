...
//System.out.println("---queryUser---");
    ...
    private boolean queryUser()
    {
        ...
        tSBql.append("' or username='"+mLDUserSchema.getUserCode()+"') and password = '");
...
//                                "***");
        ...
        //校验状态
        if(tLDUserSchema.getUserState()!=null&&"1".equals(tLDUserSchema.getUserState().trim()))
        {
            CError tError = new CError();
            tError.moduleName = "LDUserBL";
            tError.functionName = "queryUser";
            tError.errorMessage = "用户已经失效,请与管理员联系!";
            this.mErrors.addOneError(tError);
...
//        System.out.println("matchCount:" + matchCount);
        ...
        //校验lecense
//        String qSQL = "select sysvarvalue from ldsysvar where sysvar = 'LECENSE'";
//        ExeSQL es = new ExeSQL();
//        String LDate = es.getOneValue(qSQL);
//        LisIDEA tIdea = new LisIDEA();
//        LDate = tIdea.decryptString(LDate);
//        String NewDate = LDate.substring(0, 4)+"-"+LDate.substring(4, 6)+"-"+LDate.substring(6, 8);
//        int Days = PubFun.calInterval(PubFun.getCurrentDate(),NewDate, "D");
//        if(Days<1)
//        {
//            CError tError = new CError();
//            tError.moduleName = "LDUserBL";
//            tError.functionName = "queryUser";
//            tError.errorMessage = "LECENSE已经失效,请重新输入序列号!";
//            this.mErrors.addOneError(tError);
//            return false;
//        }
