...
//	    //发送调用
		xml=t.SendMessage("xd000387", "xd000387", "xd00038723", "18611507109", "您的验证码是8643【清华园社区】", "","").toString();
...
//		System.out.println("错误代码："+xmlentity.getError());
	...
	//发送短信
	public StringBuffer SendMessage(String userid,String account,String password,String mobile,String content,String sendTime,String extno)
	{
		...
		try {
			...
			url=new URL("http://114.113.154.5/sms.aspx?action=send&userid="+userid+"&account="+account+"&password="+password+"&mobile="+mobile+"&content="+send_content+"&sendTime="+sendTime+"&extno="+extno);	
			con = (HttpURLConnection)url.openConnection();
