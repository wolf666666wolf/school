...
public class PubUI
{
     ...
     * @param cBLForBL 后来逻辑处理类名称(需要传入包路径,如:com.sinosoft.lis.finfee.TempFeeBL)
     * @return 如果后台数据处理操作成功，将结果存在内部VData对象中，返回true；处理失败则返回false
     */
    public boolean submitData(VData cInputData, String cOperate,String cBLForBL) throws ClassNotFoundException,
