	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.getCodeType() == null || this.getCodeType().equals("null")) {
				...
				pstmt.setString(1, StrTool.space(this.getCodeType(), 20));
			}
			if(this.getCode() == null || this.getCode().equals("null")) {
				pstmt.setNull(2, 1);
			} else {
				pstmt.setString(2, StrTool.space(this.getCode(), 20));
			}
			pstmt.executeUpdate();
			pstmt.close();
		} catch (Exception ex) {
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getCodeType() == null || this.getCodeType().equals("null")) {
				...
				pstmt.setString(7, StrTool.space(this.getCodeType(), 20));
			}
			if(this.getCode() == null || this.getCode().equals("null")) {
				pstmt.setNull(8, 1);
			} else {
				pstmt.setString(8, StrTool.space(this.getCode(), 20));
			}
			pstmt.executeUpdate();
			pstmt.close();
		} catch (Exception ex) {
