...
public class LDUserTOMenuGrpSchema implements Schema, Cloneable
{
	...
	{
		if (SysConst.CHANGECHARSET && UserCode != null && !UserCode.equals(""))
		{
...
strReturn.append(StrTool.cTrim( StrTool.unicodeToGBK(UserCode))); strReturn.append(SysConst.PACKAGESPILTER);
strReturn.append(StrTool.cTrim( StrTool.unicodeToGBK(MenuGrpCode)));
