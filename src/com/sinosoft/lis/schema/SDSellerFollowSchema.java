...
/*
 * <p>ClassName: SDSellerFollowSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class SDSellerFollowSchema implements Schema, Cloneable
{
	// @Field
	/** 流水号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		SDSellerFollowSchema cloned = (SDSellerFollowSchema)super.clone();
...
if(FollowDate==null)FollowDate="";
	...
	public void setFollowDate(String aFollowDate)
	{
		FollowDate = aFollowDate;
	}
...
if(FollowTime==null)FollowTime="";
	...
	public void setFollowTime(String aFollowTime)
	{
...
if(R15==null)R15="";
	...
	/**
	* 使用另外一个 SDSellerFollowSchema 对象给 Schema 赋值
	* @param: aSDSellerFollowSchema SDSellerFollowSchema
	**/
	public void setSchema(SDSellerFollowSchema aSDSellerFollowSchema)
	{
		this.SerialNo = aSDSellerFollowSchema.getSerialNo();
		this.UserID = aSDSellerFollowSchema.getUserID();
		this.SellerID = aSDSellerFollowSchema.getSellerID();
		this.FollowDate = aSDSellerFollowSchema.getFollowDate();
		this.FollowTime = aSDSellerFollowSchema.getFollowTime();
		this.R1 = aSDSellerFollowSchema.getR1();
		this.R2 = aSDSellerFollowSchema.getR2();
		this.R3 = aSDSellerFollowSchema.getR3();
		this.R4 = aSDSellerFollowSchema.getR4();
		this.R5 = aSDSellerFollowSchema.getR5();
		this.R6 = aSDSellerFollowSchema.getR6();
		this.R7 = aSDSellerFollowSchema.getR7();
		this.R8 = aSDSellerFollowSchema.getR8();
		this.R9 = aSDSellerFollowSchema.getR9();
		this.R10 = aSDSellerFollowSchema.getR10();
		this.R11 = aSDSellerFollowSchema.getR11();
		this.R12 = aSDSellerFollowSchema.getR12();
		this.R13 = aSDSellerFollowSchema.getR13();
		this.R14 = aSDSellerFollowSchema.getR14();
		this.R15 = aSDSellerFollowSchema.getR15();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		try
		{
			...
			if( rs.getString("FollowDate") == null )
				this.FollowDate = null;
			else
				this.FollowDate = rs.getString("FollowDate").trim();

			if( rs.getString("FollowTime") == null )
				this.FollowTime = null;
			else
				this.FollowTime = rs.getString("FollowTime").trim();
		...
		{
			System.out.println("数据库中的SDSellerFollow表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "SDSellerFollowSchema";
	...
	public SDSellerFollowSchema getSchema()
	{
		SDSellerFollowSchema aSDSellerFollowSchema = new SDSellerFollowSchema();
		aSDSellerFollowSchema.setSchema(this);
		return aSDSellerFollowSchema;
	}

	public SDSellerFollowDB getDB()
	{
		SDSellerFollowDB aDBOper = new SDSellerFollowDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpSDSellerFollow描述/A>表字段
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(FollowDate)); strReturn.append(SysConst.PACKAGESPILTER);
		strReturn.append(StrTool.cTrim(FollowTime)); strReturn.append(SysConst.PACKAGESPILTER);
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpSDSellerFollow>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			FollowDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
			FollowTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
	...
	**/
	public String getV(String FCode)
	{
		...
		if (FCode.equalsIgnoreCase("FollowDate"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(FollowDate));
		}
		if (FCode.equalsIgnoreCase("FollowTime"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(FollowTime));
		}
	...
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 2:
				...
				break;
			case 3:
				strFieldValue = StrTool.GBKToUnicode(FollowDate);
				break;
			case 4:
				strFieldValue = StrTool.GBKToUnicode(FollowTime);
				break;
			case 5:
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		SDSellerFollowSchema other = (SDSellerFollowSchema)otherObject;
		return
			SerialNo.equals(other.getSerialNo())
			&& UserID.equals(other.getUserID())
			&& SellerID.equals(other.getSellerID())
			&& FollowDate.equals(other.getFollowDate())
			&& FollowTime.equals(other.getFollowTime())
	...
	**/
	public int getFieldIndex(String strFieldName)
	{
		...
		if( strFieldName.equals("FollowDate") ) {
			return 3;
		}
		if( strFieldName.equals("FollowTime") ) {
			return 4;
		}
	...
	public String getFieldName(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 2:
				...
				break;
			case 3:
				strFieldName = "FollowDate";
				break;
			case 4:
				strFieldName = "FollowTime";
				break;
			case 5:
				strFieldName = "R1";
				break;
