...
/*
 * <p>ClassName: SDSellerClassSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class SDSellerClassSchema implements Schema, Cloneable
{
	// @Field
	/** 流水号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		SDSellerClassSchema cloned = (SDSellerClassSchema)super.clone();
...
if(R15==null)R15="";
	...
	/**
	* 使用另外一个 SDSellerClassSchema 对象给 Schema 赋值
	* @param: aSDSellerClassSchema SDSellerClassSchema
	**/
	public void setSchema(SDSellerClassSchema aSDSellerClassSchema)
	{
		this.SerialNo = aSDSellerClassSchema.getSerialNo();
		this.ChannelCode = aSDSellerClassSchema.getChannelCode();
		this.ClassName = aSDSellerClassSchema.getClassName();
		this.R1 = aSDSellerClassSchema.getR1();
		this.R2 = aSDSellerClassSchema.getR2();
		this.R3 = aSDSellerClassSchema.getR3();
		this.R4 = aSDSellerClassSchema.getR4();
		this.R5 = aSDSellerClassSchema.getR5();
		this.R6 = aSDSellerClassSchema.getR6();
		this.R7 = aSDSellerClassSchema.getR7();
		this.R8 = aSDSellerClassSchema.getR8();
		this.R9 = aSDSellerClassSchema.getR9();
		this.R10 = aSDSellerClassSchema.getR10();
		this.R11 = aSDSellerClassSchema.getR11();
		this.R12 = aSDSellerClassSchema.getR12();
		this.R13 = aSDSellerClassSchema.getR13();
		this.R14 = aSDSellerClassSchema.getR14();
		this.R15 = aSDSellerClassSchema.getR15();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			System.out.println("数据库中的SDSellerClass表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "SDSellerClassSchema";
	...
	public SDSellerClassSchema getSchema()
	{
		SDSellerClassSchema aSDSellerClassSchema = new SDSellerClassSchema();
		aSDSellerClassSchema.setSchema(this);
		return aSDSellerClassSchema;
	}

	public SDSellerClassDB getDB()
	{
		SDSellerClassDB aDBOper = new SDSellerClassDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpSDSellerClass>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			R1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
			R2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
			R3 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
			R4 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			R5 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			R6 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			R7 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			R8 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			R9 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			R10 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			R11 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			R12 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
			R13 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			R14 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			R15 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		SDSellerClassSchema other = (SDSellerClassSchema)otherObject;
		return
