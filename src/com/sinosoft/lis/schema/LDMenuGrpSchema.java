...
public class LDMenuGrpSchema implements Schema, Cloneable
{
	...
	{
		if (SysConst.CHANGECHARSET && MenuGrpCode != null && !MenuGrpCode.equals(""))
		{
	...
	{
		if (SysConst.CHANGECHARSET && MenuGrpName != null && !MenuGrpName.equals(""))
		{
	...
	{
		if (SysConst.CHANGECHARSET && MenuGrpDescription != null && !MenuGrpDescription.equals(""))
		{
	...
	{
		if (SysConst.CHANGECHARSET && MenuSign != null && !MenuSign.equals(""))
		{
...
strReturn.append(StrTool.cTrim( StrTool.unicodeToGBK(MenuGrpCode))); strReturn.append(SysConst.PACKAGESPILTER);
strReturn.append(StrTool.cTrim( StrTool.unicodeToGBK(MenuGrpName))); strReturn.append(SysConst.PACKAGESPILTER);
strReturn.append(StrTool.cTrim( StrTool.unicodeToGBK(MenuGrpDescription))); strReturn.append(SysConst.PACKAGESPILTER);
strReturn.append(StrTool.cTrim( StrTool.unicodeToGBK(MenuSign))); strReturn.append(SysConst.PACKAGESPILTER);
