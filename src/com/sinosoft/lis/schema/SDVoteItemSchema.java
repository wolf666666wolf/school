...
/*
 * <p>ClassName: SDVoteItemSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class SDVoteItemSchema implements Schema, Cloneable
{
	// @Field
	/** 项目编码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		SDVoteItemSchema cloned = (SDVoteItemSchema)super.clone();
...
if(VoteItem==null)VoteItem="";
	...
	public void setVoteItem(String aVoteItem)
	{
		VoteItem = aVoteItem;
	}
	public String getVoteSeq()
	{
if(VoteSeq==null)VoteSeq="";
		return VoteSeq;
	}
	public void setVoteSeq(String aVoteSeq)
	{
		VoteSeq = aVoteSeq;
	}
...
if(VoteCount==null)VoteCount="";
	...
	public void setVoteCount(String aVoteCount)
	{
...
if(R15==null)R15="";
	...
	/**
	* 使用另外一个 SDVoteItemSchema 对象给 Schema 赋值
	* @param: aSDVoteItemSchema SDVoteItemSchema
	**/
	public void setSchema(SDVoteItemSchema aSDVoteItemSchema)
	{
		this.ItemNo = aSDVoteItemSchema.getItemNo();
		this.TopicNo = aSDVoteItemSchema.getTopicNo();
		this.VoteNo = aSDVoteItemSchema.getVoteNo();
		this.VoteItem = aSDVoteItemSchema.getVoteItem();
		this.VoteSeq = aSDVoteItemSchema.getVoteSeq();
		this.VoteCount = aSDVoteItemSchema.getVoteCount();
		this.R1 = aSDVoteItemSchema.getR1();
		this.R2 = aSDVoteItemSchema.getR2();
		this.R3 = aSDVoteItemSchema.getR3();
		this.R4 = aSDVoteItemSchema.getR4();
		this.R5 = aSDVoteItemSchema.getR5();
		this.R6 = aSDVoteItemSchema.getR6();
		this.R7 = aSDVoteItemSchema.getR7();
		this.R8 = aSDVoteItemSchema.getR8();
		this.R9 = aSDVoteItemSchema.getR9();
		this.R10 = aSDVoteItemSchema.getR10();
		this.R11 = aSDVoteItemSchema.getR11();
		this.R12 = aSDVoteItemSchema.getR12();
		this.R13 = aSDVoteItemSchema.getR13();
		this.R14 = aSDVoteItemSchema.getR14();
		this.R15 = aSDVoteItemSchema.getR15();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		try
		{
			...
			if( rs.getString("VoteItem") == null )
				this.VoteItem = null;
			else
				this.VoteItem = rs.getString("VoteItem").trim();

			if( rs.getString("VoteSeq") == null )
				this.VoteSeq = null;
			else
				this.VoteSeq = rs.getString("VoteSeq").trim();

			if( rs.getString("VoteCount") == null )
				this.VoteCount = null;
			else
				this.VoteCount = rs.getString("VoteCount").trim();
		...
		{
			System.out.println("数据库中的SDVoteItem表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "SDVoteItemSchema";
	...
	public SDVoteItemSchema getSchema()
	{
		SDVoteItemSchema aSDVoteItemSchema = new SDVoteItemSchema();
		aSDVoteItemSchema.setSchema(this);
		return aSDVoteItemSchema;
	}

	public SDVoteItemDB getDB()
	{
		SDVoteItemDB aDBOper = new SDVoteItemDB();
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(VoteItem)); strReturn.append(SysConst.PACKAGESPILTER);
		strReturn.append(StrTool.cTrim(VoteSeq)); strReturn.append(SysConst.PACKAGESPILTER);
		strReturn.append(StrTool.cTrim(VoteCount)); strReturn.append(SysConst.PACKAGESPILTER);
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpSDVoteItem>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			ItemNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 1, SysConst.PACKAGESPILTER );
			TopicNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 2, SysConst.PACKAGESPILTER );
			VoteNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
			VoteItem = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
			VoteSeq = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
			VoteCount = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
			R1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			R2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			R3 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			R4 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			R5 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			R6 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			R7 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			R8 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			R9 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
			R10 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			R11 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			R12 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			R13 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, SysConst.PACKAGESPILTER );
			R14 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, SysConst.PACKAGESPILTER );
			R15 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
		}
	...
	**/
	public String getV(String FCode)
	{
		...
		if (FCode.equalsIgnoreCase("VoteItem"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(VoteItem));
		}
		if (FCode.equalsIgnoreCase("VoteSeq"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(VoteSeq));
		}
		if (FCode.equalsIgnoreCase("VoteCount"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(VoteCount));
		}
	...
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 2:
				...
				break;
			case 3:
				strFieldValue = StrTool.GBKToUnicode(VoteItem);
				break;
			case 4:
				strFieldValue = StrTool.GBKToUnicode(VoteSeq);
				break;
			case 5:
				strFieldValue = StrTool.GBKToUnicode(VoteCount);
				break;
			case 6:
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		SDVoteItemSchema other = (SDVoteItemSchema)otherObject;
		return
			ItemNo.equals(other.getItemNo())
			&& TopicNo.equals(other.getTopicNo())
			&& VoteNo.equals(other.getVoteNo())
			&& VoteItem.equals(other.getVoteItem())
			&& VoteSeq.equals(other.getVoteSeq())
			&& VoteCount.equals(other.getVoteCount())
	...
	**/
	public int getFieldIndex(String strFieldName)
	{
		...
		if( strFieldName.equals("VoteItem") ) {
			return 3;
		}
		if( strFieldName.equals("VoteSeq") ) {
			return 4;
		}
		if( strFieldName.equals("VoteCount") ) {
			return 5;
		}
	...
	public String getFieldName(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 2:
				...
				break;
			case 3:
				strFieldName = "VoteItem";
				break;
			case 4:
				strFieldName = "VoteSeq";
				break;
			case 5:
				strFieldName = "VoteCount";
				break;
			case 6:
				strFieldName = "R1";
				break;
