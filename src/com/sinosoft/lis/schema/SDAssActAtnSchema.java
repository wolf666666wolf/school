...
/*
 * <p>ClassName: SDAssActAtnSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class SDAssActAtnSchema implements Schema, Cloneable
{
	// @Field
	/** 流水号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		SDAssActAtnSchema cloned = (SDAssActAtnSchema)super.clone();
...
if(UserID==null)UserID="";
	...
	{
if(AtnDate==null)AtnDate="";
		return AtnDate;
	}
	public void setAtnDate(String aAtnDate)
	{
		AtnDate = aAtnDate;
	}
	public String getAtnTime()
	{
if(AtnTime==null)AtnTime="";
		return AtnTime;
	}
	public void setAtnTime(String aAtnTime)
	{
		AtnTime = aAtnTime;
	}
	public String getR1()
...
if(R15==null)R15="";
	...
	/**
	* 使用另外一个 SDAssActAtnSchema 对象给 Schema 赋值
	* @param: aSDAssActAtnSchema SDAssActAtnSchema
	**/
	public void setSchema(SDAssActAtnSchema aSDAssActAtnSchema)
	{
		this.SerialNo = aSDAssActAtnSchema.getSerialNo();
		this.ActID = aSDAssActAtnSchema.getActID();
		this.UserID = aSDAssActAtnSchema.getUserID();
		this.AtnDate = aSDAssActAtnSchema.getAtnDate();
		this.AtnTime = aSDAssActAtnSchema.getAtnTime();
		this.R1 = aSDAssActAtnSchema.getR1();
		this.R2 = aSDAssActAtnSchema.getR2();
		this.R3 = aSDAssActAtnSchema.getR3();
		this.R4 = aSDAssActAtnSchema.getR4();
		this.R5 = aSDAssActAtnSchema.getR5();
		this.R6 = aSDAssActAtnSchema.getR6();
		this.R7 = aSDAssActAtnSchema.getR7();
		this.R8 = aSDAssActAtnSchema.getR8();
		this.R9 = aSDAssActAtnSchema.getR9();
		this.R10 = aSDAssActAtnSchema.getR10();
		this.R11 = aSDAssActAtnSchema.getR11();
		this.R12 = aSDAssActAtnSchema.getR12();
		this.R13 = aSDAssActAtnSchema.getR13();
		this.R14 = aSDAssActAtnSchema.getR14();
		this.R15 = aSDAssActAtnSchema.getR15();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		try
		{
			...
			if( rs.getString("AtnDate") == null )
				this.AtnDate = null;
			else
				this.AtnDate = rs.getString("AtnDate").trim();

			if( rs.getString("AtnTime") == null )
				this.AtnTime = null;
			else
				this.AtnTime = rs.getString("AtnTime").trim();
		...
		{
			System.out.println("数据库中的SDAssActAtn表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "SDAssActAtnSchema";
	...
	public SDAssActAtnSchema getSchema()
	{
		SDAssActAtnSchema aSDAssActAtnSchema = new SDAssActAtnSchema();
		aSDAssActAtnSchema.setSchema(this);
		return aSDAssActAtnSchema;
	}

	public SDAssActAtnDB getDB()
	{
		SDAssActAtnDB aDBOper = new SDAssActAtnDB();
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(AtnDate)); strReturn.append(SysConst.PACKAGESPILTER);
		strReturn.append(StrTool.cTrim(AtnTime)); strReturn.append(SysConst.PACKAGESPILTER);
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpSDAssActAtn>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			ActID = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 2, SysConst.PACKAGESPILTER );
			UserID = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
			AtnDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
			AtnTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
	...
	**/
	public String getV(String FCode)
	{
		...
		if (FCode.equalsIgnoreCase("AtnDate"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(AtnDate));
		}
		if (FCode.equalsIgnoreCase("AtnTime"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(AtnTime));
		}
	...
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 2:
				...
				break;
			case 3:
				strFieldValue = StrTool.GBKToUnicode(AtnDate);
				break;
			case 4:
				strFieldValue = StrTool.GBKToUnicode(AtnTime);
				break;
			case 5:
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		SDAssActAtnSchema other = (SDAssActAtnSchema)otherObject;
		return
			SerialNo.equals(other.getSerialNo())
			&& ActID.equals(other.getActID())
			&& UserID.equals(other.getUserID())
			&& AtnDate.equals(other.getAtnDate())
			&& AtnTime.equals(other.getAtnTime())
	...
	**/
	public int getFieldIndex(String strFieldName)
	{
		...
		if( strFieldName.equals("AtnDate") ) {
			return 3;
		}
		if( strFieldName.equals("AtnTime") ) {
			return 4;
		}
	...
	public String getFieldName(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 2:
				...
				break;
			case 3:
				strFieldName = "AtnDate";
				break;
			case 4:
				strFieldName = "AtnTime";
				break;
			case 5:
				strFieldName = "R1";
				break;
