...
import com.sinosoft.lis.db.SDLinksDB;

/*
 * <p>ClassName: SDLinksSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class SDLinksSchema implements Schema, Cloneable
{
	// @Field
	/** 流水号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		SDLinksSchema cloned = (SDLinksSchema)super.clone();
...
if(R15==null)R15="";
	...
	/**
	* 使用另外一个 SDLinksSchema 对象给 Schema 赋值
	* @param: aSDLinksSchema SDLinksSchema
	**/
	public void setSchema(SDLinksSchema aSDLinksSchema)
	{
		this.SerialNo = aSDLinksSchema.getSerialNo();
		this.ChannelName = aSDLinksSchema.getChannelName();
		this.SEQ = aSDLinksSchema.getSEQ();
		this.URL = aSDLinksSchema.getURL();
		this.R1 = aSDLinksSchema.getR1();
		this.R2 = aSDLinksSchema.getR2();
		this.R3 = aSDLinksSchema.getR3();
		this.R4 = aSDLinksSchema.getR4();
		this.R5 = aSDLinksSchema.getR5();
		this.R6 = aSDLinksSchema.getR6();
		this.R7 = aSDLinksSchema.getR7();
		this.R8 = aSDLinksSchema.getR8();
		this.R9 = aSDLinksSchema.getR9();
		this.R10 = aSDLinksSchema.getR10();
		this.R11 = aSDLinksSchema.getR11();
		this.R12 = aSDLinksSchema.getR12();
		this.R13 = aSDLinksSchema.getR13();
		this.R14 = aSDLinksSchema.getR14();
		this.R15 = aSDLinksSchema.getR15();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		try
		{
			...
			if( rs.getString("SEQ") == null )
				...
				this.SEQ = rs.getString("SEQ").trim();

			if( rs.getString("URL") == null )
				this.URL = null;
			else
				this.URL = rs.getString("URL").trim();
		...
		{
			System.out.println("数据库中的SDLinks表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "SDLinksSchema";
	...
	public SDLinksSchema getSchema()
	{
		SDLinksSchema aSDLinksSchema = new SDLinksSchema();
		aSDLinksSchema.setSchema(this);
		return aSDLinksSchema;
	}

	public SDLinksDB getDB()
	{
		SDLinksDB aDBOper = new SDLinksDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpSDLinks描述/A>表字段
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(SEQ)); strReturn.append(SysConst.PACKAGESPILTER);
		strReturn.append(StrTool.cTrim(URL)); strReturn.append(SysConst.PACKAGESPILTER);
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpSDLinks>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			SEQ = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
			URL = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
			R1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
			R2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
			R3 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			R4 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			R5 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			R6 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			R7 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			R8 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			R9 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			R10 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			R11 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
			R12 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			R13 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			R14 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			R15 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, SysConst.PACKAGESPILTER );
		}
	...
	**/
	public String getV(String FCode)
	{
		...
		if (FCode.equalsIgnoreCase("SEQ"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(SEQ));
		}
	...
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 1:
				...
				break;
			case 2:
				strFieldValue = StrTool.GBKToUnicode(SEQ);
				break;
			case 3:
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		SDLinksSchema other = (SDLinksSchema)otherObject;
		return
			SerialNo.equals(other.getSerialNo())
			&& ChannelName.equals(other.getChannelName())
			&& SEQ.equals(other.getSEQ())
