...
/*
 * <p>ClassName: SDProductAssessSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class SDProductAssessSchema implements Schema, Cloneable
{
	// @Field
	/** 流水号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		SDProductAssessSchema cloned = (SDProductAssessSchema)super.clone();
...
if(AssEssDate==null)AssEssDate="";
	...
	public void setAssEssDate(String aAssEssDate)
	{
		AssEssDate = aAssEssDate;
	}
	public String getAssEssTime()
	{
if(AssEssTime==null)AssEssTime="";
		return AssEssTime;
	}
...
if(R15==null)R15="";
	...
	/**
	* 使用另外一个 SDProductAssessSchema 对象给 Schema 赋值
	* @param: aSDProductAssessSchema SDProductAssessSchema
	**/
	public void setSchema(SDProductAssessSchema aSDProductAssessSchema)
	{
		this.SerialNo = aSDProductAssessSchema.getSerialNo();
		this.UserID = aSDProductAssessSchema.getUserID();
		this.OrderID = aSDProductAssessSchema.getOrderID();
		this.AssEssDate = aSDProductAssessSchema.getAssEssDate();
		this.AssEssTime = aSDProductAssessSchema.getAssEssTime();
		this.Title = aSDProductAssessSchema.getTitle();
		this.Level = aSDProductAssessSchema.getLevel();
		this.Community = aSDProductAssessSchema.getCommunity();
		this.Content = aSDProductAssessSchema.getContent();
		this.Phone = aSDProductAssessSchema.getPhone();
		this.R1 = aSDProductAssessSchema.getR1();
		this.R2 = aSDProductAssessSchema.getR2();
		this.R3 = aSDProductAssessSchema.getR3();
		this.R4 = aSDProductAssessSchema.getR4();
		this.R5 = aSDProductAssessSchema.getR5();
		this.R6 = aSDProductAssessSchema.getR6();
		this.R7 = aSDProductAssessSchema.getR7();
		this.R8 = aSDProductAssessSchema.getR8();
		this.R9 = aSDProductAssessSchema.getR9();
		this.R10 = aSDProductAssessSchema.getR10();
		this.R11 = aSDProductAssessSchema.getR11();
		this.R12 = aSDProductAssessSchema.getR12();
		this.R13 = aSDProductAssessSchema.getR13();
		this.R14 = aSDProductAssessSchema.getR14();
		this.R15 = aSDProductAssessSchema.getR15();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		try
		{
			...
			if( rs.getString("AssEssDate") == null )
				this.AssEssDate = null;
			else
				this.AssEssDate = rs.getString("AssEssDate").trim();
			...
			if( rs.getString("Community") == null )
				this.Community = null;
			else
				this.Community = rs.getString("Community").trim();
		...
		{
			System.out.println("数据库中的SDProductAssess表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "SDProductAssessSchema";
	...
	public SDProductAssessSchema getSchema()
	{
		SDProductAssessSchema aSDProductAssessSchema = new SDProductAssessSchema();
		aSDProductAssessSchema.setSchema(this);
		return aSDProductAssessSchema;
	}

	public SDProductAssessDB getDB()
	{
		SDProductAssessDB aDBOper = new SDProductAssessDB();
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(AssEssDate)); strReturn.append(SysConst.PACKAGESPILTER);
		...
		strReturn.append(StrTool.cTrim(Community)); strReturn.append(SysConst.PACKAGESPILTER);
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpSDProductAssess>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			OrderID = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
			AssEssDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
			AssEssTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
			Title = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
			Level = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			Community = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			Content = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			Phone = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			R1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			R2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			R3 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			R4 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			R5 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
			R6 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			R7 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			R8 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			R9 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, SysConst.PACKAGESPILTER );
			R10 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, SysConst.PACKAGESPILTER );
			R11 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
			R12 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, SysConst.PACKAGESPILTER );
			R13 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, SysConst.PACKAGESPILTER );
			R14 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			R15 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
		}
	...
	**/
	public String getV(String FCode)
	{
		...
		if (FCode.equalsIgnoreCase("AssEssDate"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(AssEssDate));
		}
		...
		if (FCode.equalsIgnoreCase("Community"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(Community));
		}
	...
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 2:
				...
				break;
			case 3:
				strFieldValue = StrTool.GBKToUnicode(AssEssDate);
				break;
			case 4:
			...
			case 6:
				...
				break;
			case 7:
				strFieldValue = StrTool.GBKToUnicode(Community);
				break;
			case 8:
	...
	**/
	public int getFieldIndex(String strFieldName)
	{
		...
		if( strFieldName.equals("AssEssDate") ) {
			return 3;
		}
		...
		if( strFieldName.equals("Community") ) {
			return 7;
		}
