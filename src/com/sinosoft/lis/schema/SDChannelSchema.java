...
/*
 * <p>ClassName: SDChannelSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class SDChannelSchema implements Schema, Cloneable
{
	// @Field
	/** 流水号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		SDChannelSchema cloned = (SDChannelSchema)super.clone();
...
if(ParentChannel==null)ParentChannel="";
	...
	public void setParentChannel(String aParentChannel)
	{
		ParentChannel = aParentChannel;
	}
	public String getChannelLevel()
	{
if(ChannelLevel==null)ChannelLevel="";
		return ChannelLevel;
	}
	public void setChannelLevel(String aChannelLevel)
	{
		ChannelLevel = aChannelLevel;
	}
...
if(R15==null)R15="";
	...
	/**
	* 使用另外一个 SDChannelSchema 对象给 Schema 赋值
	* @param: aSDChannelSchema SDChannelSchema
	**/
	public void setSchema(SDChannelSchema aSDChannelSchema)
	{
		this.SerialNo = aSDChannelSchema.getSerialNo();
		this.ChannelName = aSDChannelSchema.getChannelName();
		this.ParentChannel = aSDChannelSchema.getParentChannel();
		this.ChannelLevel = aSDChannelSchema.getChannelLevel();
		this.URL = aSDChannelSchema.getURL();
		this.R1 = aSDChannelSchema.getR1();
		this.R2 = aSDChannelSchema.getR2();
		this.R3 = aSDChannelSchema.getR3();
		this.R4 = aSDChannelSchema.getR4();
		this.R5 = aSDChannelSchema.getR5();
		this.R6 = aSDChannelSchema.getR6();
		this.R7 = aSDChannelSchema.getR7();
		this.R8 = aSDChannelSchema.getR8();
		this.R9 = aSDChannelSchema.getR9();
		this.R10 = aSDChannelSchema.getR10();
		this.R11 = aSDChannelSchema.getR11();
		this.R12 = aSDChannelSchema.getR12();
		this.R13 = aSDChannelSchema.getR13();
		this.R14 = aSDChannelSchema.getR14();
		this.R15 = aSDChannelSchema.getR15();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		try
		{
			...
			if( rs.getString("ParentChannel") == null )
				this.ParentChannel = null;
			else
				this.ParentChannel = rs.getString("ParentChannel").trim();

			if( rs.getString("ChannelLevel") == null )
				this.ChannelLevel = null;
			else
				this.ChannelLevel = rs.getString("ChannelLevel").trim();
		...
		{
			System.out.println("数据库中的SDChannel表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "SDChannelSchema";
	...
	public SDChannelSchema getSchema()
	{
		SDChannelSchema aSDChannelSchema = new SDChannelSchema();
		aSDChannelSchema.setSchema(this);
		return aSDChannelSchema;
	}

	public SDChannelDB getDB()
	{
		SDChannelDB aDBOper = new SDChannelDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpSDChannel描述/A>表字段
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(ParentChannel)); strReturn.append(SysConst.PACKAGESPILTER);
		strReturn.append(StrTool.cTrim(ChannelLevel)); strReturn.append(SysConst.PACKAGESPILTER);
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpSDChannel>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			ParentChannel = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
			ChannelLevel = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
			URL = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
	...
	**/
	public String getV(String FCode)
	{
		...
		if (FCode.equalsIgnoreCase("ParentChannel"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(ParentChannel));
		}
		if (FCode.equalsIgnoreCase("ChannelLevel"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(ChannelLevel));
		}
	...
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 1:
				...
				break;
			case 2:
				strFieldValue = StrTool.GBKToUnicode(ParentChannel);
				break;
			case 3:
				strFieldValue = StrTool.GBKToUnicode(ChannelLevel);
				break;
			case 4:
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		SDChannelSchema other = (SDChannelSchema)otherObject;
		return
			SerialNo.equals(other.getSerialNo())
			&& ChannelName.equals(other.getChannelName())
			&& ParentChannel.equals(other.getParentChannel())
			&& ChannelLevel.equals(other.getChannelLevel())
	...
	**/
	public int getFieldIndex(String strFieldName)
	{
		...
		if( strFieldName.equals("ParentChannel") ) {
			return 2;
		}
		if( strFieldName.equals("ChannelLevel") ) {
			return 3;
		}
	...
	public String getFieldName(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 1:
				...
				break;
			case 2:
				strFieldName = "ParentChannel";
				break;
			case 3:
				strFieldName = "ChannelLevel";
				break;
			case 4:
				strFieldName = "URL";
				break;
