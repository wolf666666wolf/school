...
/*
 * <p>ClassName: SDSendCodeTraceDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class SDSendCodeTraceDBSet extends SDSendCodeTraceSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public SDSendCodeTraceDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "SDSendCodeTraceDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getPhone() == null || this.get(i).getPhone().equals("null")) {
				...
				pstmt.setString(2, this.get(i).getPhone());
			}
			...
			if(this.get(i).getSendDate() == null || this.get(i).getSendDate().equals("null")) {
				...
				pstmt.setString(4, this.get(i).getSendDate());
			}
			if(this.get(i).getSendTime() == null || this.get(i).getSendTime().equals("null")) {
				pstmt.setString(5,null);
			} else {
				pstmt.setString(5, this.get(i).getSendTime());
			}
