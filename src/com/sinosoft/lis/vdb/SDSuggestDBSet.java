...
/*
 * <p>ClassName: SDSuggestDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class SDSuggestDBSet extends SDSuggestSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public SDSuggestDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "SDSuggestDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getNickName() == null || this.get(i).getNickName().equals("null")) {
				...
				pstmt.setString(3, this.get(i).getNickName());
			}
			...
			if(this.get(i).getCom() == null || this.get(i).getCom().equals("null")) {
				pstmt.setString(6,null);
			} else {
				pstmt.setString(6, this.get(i).getCom());
			}
			...
			if(this.get(i).getSuggestDate() == null || this.get(i).getSuggestDate().equals("null")) {
				pstmt.setString(8,null);
			} else {
				pstmt.setString(8, this.get(i).getSuggestDate());
			}
			if(this.get(i).getSuggestTime() == null || this.get(i).getSuggestTime().equals("null")) {
				pstmt.setString(9,null);
			} else {
				pstmt.setString(9, this.get(i).getSuggestTime());
			}
			if(this.get(i).getDealFlag() == null || this.get(i).getDealFlag().equals("null")) {
				pstmt.setString(10,null);
			} else {
				pstmt.setString(10, this.get(i).getDealFlag());
			}
