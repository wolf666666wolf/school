...
/*
 * <p>ClassName: SDSellerFollowDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class SDSellerFollowDBSet extends SDSellerFollowSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public SDSellerFollowDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "SDSellerFollowDBSet";
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getFollowDate() == null || this.get(i).getFollowDate().equals("null")) {
				pstmt.setString(4,null);
			} else {
				pstmt.setString(4, this.get(i).getFollowDate());
			}
			if(this.get(i).getFollowTime() == null || this.get(i).getFollowTime().equals("null")) {
				pstmt.setString(5,null);
			} else {
				pstmt.setString(5, this.get(i).getFollowTime());
			}
