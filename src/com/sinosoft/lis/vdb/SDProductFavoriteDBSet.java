...
/*
 * <p>ClassName: SDProductFavoriteDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class SDProductFavoriteDBSet extends SDProductFavoriteSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public SDProductFavoriteDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "SDProductFavoriteDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getPrdID() == null || this.get(i).getPrdID().equals("null")) {
				...
				pstmt.setString(3, this.get(i).getPrdID());
			}
			if(this.get(i).getFavDate() == null || this.get(i).getFavDate().equals("null")) {
				pstmt.setString(4,null);
			} else {
				pstmt.setString(4, this.get(i).getFavDate());
			}
			if(this.get(i).getFavTime() == null || this.get(i).getFavTime().equals("null")) {
				pstmt.setString(5,null);
			} else {
				pstmt.setString(5, this.get(i).getFavTime());
			}
