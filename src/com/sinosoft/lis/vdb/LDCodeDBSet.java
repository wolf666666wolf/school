	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getCodeType() == null || this.get(i).getCodeType().equals("null")) {
				...
				pstmt.setString(1, StrTool.space(this.get(i).getCodeType(), 20));
			}
			if(this.get(i).getCode() == null || this.get(i).getCode().equals("null")) {
				pstmt.setString(2,null);
			} else {
				pstmt.setString(2, StrTool.space(this.get(i).getCode(), 20));
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getCodeType() == null || this.get(i).getCodeType().equals("null")) {
				...
				pstmt.setString(7, StrTool.space(this.get(i).getCodeType(), 20));
			}
			if(this.get(i).getCode() == null || this.get(i).getCode().equals("null")) {
				pstmt.setString(8,null);
			} else {
				pstmt.setString(8, StrTool.space(this.get(i).getCode(), 20));
			}
...
ex.printStackTrace();
	...
	public boolean insert()
	{
		...
		{
            int tCount = this.size();
			pstmt = con.prepareStatement("INSERT INTO LDCode(CodeType ,Code ,CodeName ,CodeAlias ,ComCode ,OtherSign) VALUES( ? , ? , ? , ? , ? , ?)");
            for (int i = 1; i <= tCount; i++)
            {
			if(this.get(i).getCodeType() == null || this.get(i).getCodeType().equals("null")) {
				pstmt.setString(1,null);
