...
/*
 * <p>ClassName: SDAssDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class SDAssDBSet extends SDAssSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public SDAssDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getAssID() == null || this.get(i).getAssID().equals("null")) {
				...
				pstmt.setString(1, this.get(i).getAssID());
			}
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getAssName() == null || this.get(i).getAssName().equals("null")) {
				pstmt.setString(3,null);
			} else {
				pstmt.setString(3, this.get(i).getAssName());
			}
			if(this.get(i).getShotOrgName() == null || this.get(i).getShotOrgName().equals("null")) {
				pstmt.setString(4,null);
			} else {
				pstmt.setString(4, this.get(i).getShotOrgName());
			}
			if(this.get(i).getOrgName() == null || this.get(i).getOrgName().equals("null")) {
				pstmt.setString(5,null);
			} else {
				pstmt.setString(5, this.get(i).getOrgName());
			}
			if(this.get(i).getEmail() == null || this.get(i).getEmail().equals("null")) {
				pstmt.setString(6,null);
			} else {
				pstmt.setString(6, this.get(i).getEmail());
			}
			...
			if(this.get(i).getAssPeople() == null || this.get(i).getAssPeople().equals("null")) {
				pstmt.setString(8,null);
			} else {
				pstmt.setString(8, this.get(i).getAssPeople());
			}
			if(this.get(i).getAssFeature() == null || this.get(i).getAssFeature().equals("null")) {
				pstmt.setString(9,null);
			} else {
				pstmt.setString(9, this.get(i).getAssFeature());
			}
			if(this.get(i).getAssType() == null || this.get(i).getAssType().equals("null")) {
				pstmt.setString(10,null);
			} else {
				pstmt.setString(10, this.get(i).getAssType());
			}
			if(this.get(i).getWebPage() == null || this.get(i).getWebPage().equals("null")) {
				pstmt.setString(11,null);
			} else {
				pstmt.setString(11, this.get(i).getWebPage());
			}
			...
			if(this.get(i).getAssID() == null || this.get(i).getAssID().equals("null")) {
				...
				pstmt.setString(36, this.get(i).getAssID());
			}
