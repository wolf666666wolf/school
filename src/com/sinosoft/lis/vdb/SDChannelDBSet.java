...
/*
 * <p>ClassName: SDChannelDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class SDChannelDBSet extends SDChannelSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public SDChannelDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "SDChannelDBSet";
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getParentChannel() == null || this.get(i).getParentChannel().equals("null")) {
				pstmt.setString(3,null);
			} else {
				pstmt.setString(3, this.get(i).getParentChannel());
			}
			if(this.get(i).getChannelLevel() == null || this.get(i).getChannelLevel().equals("null")) {
				pstmt.setString(4,null);
			} else {
				pstmt.setString(4, this.get(i).getChannelLevel());
			}
			if(this.get(i).getURL() == null || this.get(i).getURL().equals("null")) {
				pstmt.setString(5,null);
			} else {
				pstmt.setString(5, this.get(i).getURL());
			}
