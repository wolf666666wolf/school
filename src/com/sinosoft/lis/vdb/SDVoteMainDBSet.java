...
/*
 * <p>ClassName: SDVoteMainDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class SDVoteMainDBSet extends SDVoteMainSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public SDVoteMainDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "SDVoteMainDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getVoteNo() == null || this.get(i).getVoteNo().equals("null")) {
				...
				pstmt.setString(1, this.get(i).getVoteNo());
			}
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getVoteTitle() == null || this.get(i).getVoteTitle().equals("null")) {
				pstmt.setString(2,null);
			} else {
				pstmt.setString(2, this.get(i).getVoteTitle());
			}
			if(this.get(i).getVoteType() == null || this.get(i).getVoteType().equals("null")) {
				pstmt.setString(3,null);
			} else {
				pstmt.setString(3, this.get(i).getVoteType());
			}
			if(this.get(i).getAnonyFlag() == null || this.get(i).getAnonyFlag().equals("null")) {
				pstmt.setString(4,null);
			} else {
				pstmt.setString(4, this.get(i).getAnonyFlag());
			}
			if(this.get(i).getStartDate() == null || this.get(i).getStartDate().equals("null")) {
				pstmt.setString(5,null);
			} else {
				pstmt.setString(5, this.get(i).getStartDate());
			}
			if(this.get(i).getEndDate() == null || this.get(i).getEndDate().equals("null")) {
				pstmt.setString(6,null);
			} else {
				pstmt.setString(6, this.get(i).getEndDate());
			}
			if(this.get(i).getDisplayFlag() == null || this.get(i).getDisplayFlag().equals("null")) {
				pstmt.setString(7,null);
			} else {
				pstmt.setString(7, this.get(i).getDisplayFlag());
			}
			...
			if(this.get(i).getVoteNo() == null || this.get(i).getVoteNo().equals("null")) {
				...
				pstmt.setString(23, this.get(i).getVoteNo());
			}
