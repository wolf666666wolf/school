...
<div>
	<div id="model" class="model">
		...
		<div class="wrapper clearfix">
			<div class="side-bar">
				<div class="side-nav">
					<a href="seller_center.html">商家中心</a>
					...
					<a href="seller_center2.html" class="current">资料修改</a>
				</div>
			</div>
			<div class="main">
				<div class="location clearfix" style="display:none;">
					...
					<div class="time-bar"><span>今天是<%=PubFun.getCurrentDateZh() %></span><span>您好，<%=sds.getSellerName() %></span></div>
				</div> 
			...
			<div class="form-box"> 
				<ul class="form-text">
					...
					<li class="form-item clearfix"><span class="item-title">机构简称</span>
						<input type="text" id="ShotOrgName" class="form-input text-w210" value="<%=sds.getShotOrgName()%>"><span class="tip"></span>
					</li> 
					<li class="form-item clearfix"><span class="item-title">成立日期 <i class="icon">*</i></span>
						<input type="text" id="FoundDate" class="form-input text-w210" value="<%=sds.getFoundDate()%>"  readonly>
					</li>
					<li class="form-item clearfix">
