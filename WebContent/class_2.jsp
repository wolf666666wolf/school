...
function loadList()
{
	...
	var data = 
   	...
   	po('content','getsellerlist',data);
}

function afterPost(d)
{
	//alert(t(d.rd.data.sdps));
	if(d.action=='content'&&d.operate=='getsellerlist')
	{
		if(d.rd.succ)
		{					 
		    // 附上模板  
				...
				<ul class="services-list clearfix">
					...
					<li class="services-item">
						...
						<ul class="services-info"> 
							...
							<li class="store-name"><span>{$T.record.R8}</span><span>已浏览</span></li>
						</ul>
					</li>
					{#/for}					
				</ul>
