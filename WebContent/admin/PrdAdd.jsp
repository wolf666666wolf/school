...
<table class=common border=0>
	...
	<TR class=common>
		...
		<td class=input><Input class="common" name=PrdNum readonly></td>
		<td class=title></td>
		<td class=input></td>
		<td class=title></td>
		<td class=input></td>
...
function queryData()
{
	...
	{
		var SQL = "select a.prdid,a.prdtype,a.sellerid,a.prdname,a.prdprice,a.effenddate,a.discount,a.remark,b.sellername,b.orgname,a.r1, a.r15 from sdproduct a,sdseller b where a.sellerid=b.sellerid and a.prdid='"+vno+"'";
