	...
	<%@include file="./userchkA.jsp"%>	
		...
		function loadList()
		{
			...
			var data = 
		   	...
		   	po('ass','querycontentlist',data);
		}

		function afterPost(d)
		{
			//alert(t(d.rd.data.sdps));
			if(d.action=='ass'&&d.operate=='querycontentlist')
			{
				if(d.rd.succ)
				{					 
				    // 附上模板  
		...
		<div class="wrapper clearfix">		
			<div class="button-box registration-cover-buttons"> 
				<a href="ass_contentdetail.html" class="submit-button">新增内容</a>
			</div> 
			 <!--section-->
					...
					{#foreach $T as record} 
						<table width="100%" border="0">
						  <tr>
						    ...
						    <a href="./ass_contentdetail_{$T.record.SerialNo}.html" class="join-link">编辑</a><br />
