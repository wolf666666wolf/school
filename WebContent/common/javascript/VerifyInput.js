...
function verifyElementWrap2(strInfo, strValue,boxName)
{
	...
	{
		strfocus = "try { " + strboxName + ".focus();" + " } catch (ex) {}";    //xxx modified on 2005-12-05 : old : strfocus=strboxName+".focus();";
		if (eval(boxName + ".className") == "codeno" || eval(boxName + ".className") == "warnno")    //xxx modified on 2005-12-05 : old : if (eval(boxName+".className") == "codeno")
		{
		 	strcolor = strboxName + ".className=\"warnno\";";
		}
		else if (eval(boxName + ".className") == "coolDatePicker" || eval(boxName + ".className") == "warndate")    //xxx added on 2006-03-26 : 解决 coolDatePicker 变长的问题
		{
		    strcolor = strboxName + ".className=\"warndate\";";
		}
		else if (eval(boxName + ".className") == "common3" || eval(boxName + ".className") == "warn3")    //xxx added on 2006-09-21 : 解决 common3 变短的问题
		{
